...
maxCentripetalAcceleration = 200;
  */
   ...
   *                           be metric)
   */
  public NewRunMotionProfile(DriveTrain driveTrain, RobotOdometry odometry, Pose2d initialPosition,
   ...
   *                           be metric)
   */
  private void setup(DriveTrain driveTrain, RobotOdometry odometry, List<Translation2d> intermediatePoints,
      Pose2d endPosition, double endVelocity, boolean reversed, boolean relative,
      List<TrajectoryConstraint> extraConstraints) {
